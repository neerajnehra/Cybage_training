...
public class AdminController2 {
	...
	@RequestMapping("/admin")
	@ResponseBody
	public String getHome1(@RequestParam("id") int userid ) {
		return "we got value:  : "+ userid;
	}
	//optional request param
	@RequestMapping("/admin")
	@ResponseBody
	public String getHome2(@RequestParam(name = "id", required = true) String userid ) {
		return "we got value:  : "+ userid;
	}
	//optional request param
	@RequestMapping("/admin")
	@ResponseBody
	public String getHome(@RequestParam(name = "id", required = true, defaultValue = "cybage101")
										String userid ) {
		return "we got value:  : "+ userid;
	}
	//mapping all params
